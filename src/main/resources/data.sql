...
VALUES (TRUE, 'Admin', 'Istrator', 'passwd', 'admin', NULL, '2024-01-01 00:00:00');

INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATE_DATE) 
VALUES (TRUE, 'Susi', 'Kaufgern', 'passwd', 'user1', NULL, '2024-01-01 00:00:00');

INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATE_DATE) 
VALUES (TRUE, 'Max', 'Mustermann', 'passwd', 'user2', NULL, '2024-01-01 00:00:00');

INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATE_DATE) 
VALUES (TRUE, 'Elvis', 'The King', 'passwd', 'elvis', NULL, '2024-01-01 00:00:00');
