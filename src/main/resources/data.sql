...
INSERT INTO SHIFT_SHIFT_WORKERS (SHIFT_ID, SHIFT_WORKERS_ID)
VALUES ((SELECT ID FROM SHIFT WHERE START_TIME = '2024-01-01 00:00:00'), (SELECT ID FROM USERX WHERE USERNAME = 'elvis'));
