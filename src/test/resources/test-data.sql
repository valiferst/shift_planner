...
INSERT INTO SHIFTPLAN(ID)
VALUES (101);

-- Insert Shift into SHIFT table
INSERT INTO SHIFT(ID, STARTTIME, ENDTIME, SHIFTPLAN, SHIFTWORKER)
VALUES (1001, '2024-01-02 00:08:00', '2024-01-02 00:16:00', (SELECT SHIFTPLAN FROM SHIFTPLAN WHERE ID = 101), (SELECT * FORM USERX))
